...
<body>
<h1><a href="yonetici_index.php"> Yönetim Paneli Ana Sayfası </a> / <a href="yonetici_kopek_index.php"> Köpek Yönetim Paneli  </a> / Köpek Düzenleme Paneli </h1>
...
echo "<meta HTTP-EQUIV='refresh' CONTENT='3; URL=yonetici_kopek_index.php'>";
...
$id = $_GET['id'];
$sorgu = mysql_query("SELECT * FROM `köpekler` WHERE id='$id'");
...
<form name="kopek_duzenleme_formu" method="POST" action="yonetici_kopek_duzenle.php"  enctype="multipart/form-data">
<table align="center">
<tr>
