...
<?php 
 echo "<center>"."<p  style='background-color:#d2a8ff'>"."<font face='CupiddeLocke' size='6' color='#9966CC' >".$metin['komikhayvanbasligi']."</font>"."</p>"."</center>";


$sorgu = mysql_query("SELECT * FROM komikhayvan");
