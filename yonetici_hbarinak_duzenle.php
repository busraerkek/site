...
<title>Hayvan Barınakları Yönetim Paneli</title>
</head>
<body>
<h1><a href="yonetici_index.php"> Yönetim Paneli Ana Sayfası </a> / <a href="yonetici_hbarinak_index.php">Barınak Yönetim Paneli  </a> / Barınak Düzenleme Paneli </h1>
...
$sql = "Update hayvanbarınak set adi_tr= '$adi_tr' ,adi_en= '$adi_en' , adres_tr = '$adres_tr' ,adres_en = '$adres_en' , telefon_tr= '$telefon_tr' ,telefon_en= '$telefon_en' , internetadresi_tr = '$internetadresi_tr' ,internetadresi_en = '$internetadresi_en' where id = '$id' ";
}
else {
   ...
   if (file_exists($kalici_yol_ad)) 
      ...
      if ($_FILES["dosya"]["size"]>2*1024*1024)
         ...
         if ($_FILES["dosya"]["type"]=="image/jpeg"){
			...
			$sql = "Update hayvanbarınak set adi_tr= '$adi_tr' ,adi_en= '$adi_en' , adres_tr = '$adres_tr' ,adres_en = '$adres_en' , telefon_tr= '$telefon_tr' ,telefon_en= '$telefon_en' , internetadresi_tr = '$internetadresi_tr' ,internetadresi_en = '$internetadresi_en' , resim = '$kalici_ad' where id = '$id' ";
...
echo "<meta HTTP-EQUIV='refresh' CONTENT='2; URL=yonetici_hbarinak_index.php'>";
}
else {
...
$id = $_GET['id'];
$sorgu = mysql_query("SELECT * FROM `hayvanbarınak` WHERE id='$id'");
...
<form name="hbarinak_duzenleme_formu" method="POST" action="yonetici_hbarinak_duzenle.php" enctype="multipart/form-data">
<table align="center">
<tr>
