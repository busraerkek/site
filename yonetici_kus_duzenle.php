...
<body>
<h1><a href="yonetici_index.php"> Yönetim Paneli Ana Sayfası </a> / <a href="yonetici_kus_index.php"> Kuş Yönetim Paneli  </a> / Kuş Düzenleme Paneli </h1>
...
$id = $_GET['id'];
$sorgu = mysql_query("SELECT * FROM `kuşlar` WHERE id='$id'");
...
<form name="kus_duzenleme_formu" method="POST" action="yonetici_kus_duzenle.php" enctype="multipart/form-data">
<table align="center">
<tr>
