...
<body>
<h1><a href="yonetici_index.php"> Yönetim Paneli Ana Sayfası </a> / <a href="yonetici_hbarinak_index.php">Barınak Yönetim Paneli  </a> /Barınak Ekleme Paneli </h1>
...
$sql = "Insert into hayvanbarınak (adi_tr, adi_en,adres_tr,adres_en, telefon_tr,telefon_en, internetadresi_tr,internetadresi_en,resim) values 
...
<form name="hbarinak_ekleme_formu" method="POST" action="yonetici_hbarinak_ekle.php " enctype="multipart/form-data">
<table align="center">
<tr>
