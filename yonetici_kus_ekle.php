...
<body>
<h1><a href="yonetici_index.php"> Yönetim Paneli Ana Sayfası </a> / <a href="yonetici_kus_index.php">Kuş Yönetim Paneli  </a> / Kuş Ekleme Paneli </h1>
...
$sql ="Insert into kuşlar(tur_tr,tur_en,yer_tr,yer_en,renk_tr,renk_en,bakim_tr,bakim_en,karakterozelligi_tr,karakterozelligi_en,tuysekli_tr,tuysekli_en,boyut_tr,boyut_en,resim) values
...
echo "<meta HTTP-EQUIV='refresh' CONTENT='2; URL=yonetici_kus_index.php'>";
}
else {
...
<form name="kus_ekleme_formu" method="POST" action="yonetici_kus_ekle.php"  enctype="multipart/form-data">
<table align="center">
<tr>
